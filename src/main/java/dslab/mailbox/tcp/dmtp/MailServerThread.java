  ...
  public void run() {
    try {
      ...
      while (true) {
        ...
        MailClientHandlerThread MailClientHandlerThread = new MailClientHandlerThread(client, config,  new DmtpClientProtocol(userMailboxes, emailIdGenerators, domain, users));
